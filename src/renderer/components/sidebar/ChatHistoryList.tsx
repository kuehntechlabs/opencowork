...
export function ChatHistoryList({ searchQuery }: Props) {
  ...
  }, [setActiveSession, setRightPanelPage]);
  ...
  return (
    <div className="flex flex-col gap-0.5 px-2">
      ...
      <button
        ...
        className="mb-0.5 flex items-center gap-1.5 rounded-md px-3 py-1.5 text-xs text-text transition-colors hover:bg-surface-hover"
      >
        <svg
          width="12"
          height="12"
